...
\end{monsteraction}
\begin{monsteraction}[Misty Escape]
...
\begin{monsteraction}[Multiattack (Vampire Form Only)]
The vampire makes two attacks, only one of which can be a bite attack.
\end{monsteraction}
\begin{monsteraction}[Unarmed Strike (Vampire Form Only)]
...
\end{monsteraction}
\begin{monsteraction}[Bite (Bat or Vampire Form Only)]
...
\end{monsteraction}
\begin{monsteraction}[Children of the Night (1/Day)]
...
\end{monsteraction}
\begin{monsteraction}[Bite (Costs 2 Actions)]
