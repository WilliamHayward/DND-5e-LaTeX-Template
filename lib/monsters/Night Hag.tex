...
\end{monsteraction}
\begin{monsteraction}[Night Hag Items]
...
\end{monsteraction}
\begin{monsteraction}[Shared Spellcasting (Coven Only)]
...
\end{monsteraction}
\begin{monsteraction}[Hag Eye (Coven Only)]
...
\begin{monsteraction}[Claws (Hag Form Only)]
...
\end{monsteraction}
\begin{monsteraction}[Nightmare Haunting (1/Day)]
