...
\end{monsteraction}
\begin{monsteraction}[Freedom of Movement]
...
\end{monsteraction}
\begin{monsteraction}[Lightning Storm]
...
\begin{monsteraction}[Tentacle Attack or Fling]
The kraken makes one tentacle attack or uses its Fling.
\end{monsteraction}
\begin{monsteraction}[Lightning Storm (Costs 2 Actions)]
The kraken uses Lightning Storm.
\end{monsteraction}
\begin{monsteraction}[Ink Cloud (Costs 3 Actions)]
