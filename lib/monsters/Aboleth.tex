...
\end{monsteraction}
\begin{monsteraction}[Enslave (3/day)]
...
\end{monsteraction}
\begin{monsteraction}[Tail Swipe]
The aboleth makes one tail attack.
\end{monsteraction}
\begin{monsteraction}[Psychic Drain (Costs 2 Actions)]
