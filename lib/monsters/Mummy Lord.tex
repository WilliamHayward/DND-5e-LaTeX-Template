...
\end{monsteraction}
\begin{monsteraction}[Blinding Dust]
...
\end{monsteraction}
\begin{monsteraction}[Blasphemous Word (Costs 2 Actions)]
...
\end{monsteraction}
\begin{monsteraction}[Channel Negative Energy (Costs 2 Actions)]
...
\end{monsteraction}
\begin{monsteraction}[Whirlwind of Sand (Costs 2 Actions)]
