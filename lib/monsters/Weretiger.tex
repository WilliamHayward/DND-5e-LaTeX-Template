...
\end{monsteraction}
\begin{monsteraction}[Pounce (Tiger or Hybrid Form Only)]
...
\end{monsteraction}
\begin{monsteraction}[Bite (Tiger or Hybrid Form Only)]
...
\end{monsteraction}
\begin{monsteraction}[Claw (Tiger or Hybrid Form Only)]
Melee Weapon Attack: +5 to hit, reach 5 ft., one target. Hit: 7 (1d8 + 3) slashing damage.
\end{monsteraction}
\begin{monsteraction}[Scimitar (Humanoid or Hybrid Form Only)]
Melee Weapon Attack: +5 to hit, reach 5 ft., one target. Hit: 6 (1d6 + 3) slashing damage.
\end{monsteraction}
\begin{monsteraction}[Longbow (Humanoid or Hybrid Form Only)]
